...
public class ProjectDialog extends javax.swing.JDialog {
    private SelectProjectCallBack callback;
    private List<Project> projectList;
    /**
     * Creates new form ProjectDialog
     */
    public ProjectDialog(java.awt.Frame parent, boolean modal,List<Project> projectList,SelectProjectCallBack callback,int selection_mode) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle("Выбор проекта");

        jList1.setModel(initProjectsModel());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jList1.getSelectionMode()==javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION)
            callback.projectSelected(projectList.get(jList1.getSelectedIndex()));
        else{
            List<Project> out=new ArrayList<>();
            for(int index:jList1.getSelectedIndices())
                out.add(projectList.get(index));
            callback.projectsSelected(out);
        }
